...
export const listPeriodicidadesAdministration = (repository: PeriodicidadRepository, pagina: number, limite: number) => repository.listAdministration(pagina, limite)
