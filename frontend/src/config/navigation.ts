...
export const navigation: Array<NavItem | NavGroup> = [
  ...
  { label: 'Refinanciamientos', icon: WalletCards, items: [
    { label: 'Refinanciamientos', path: '/refinanciamientos', icon: WalletCards }, { label: 'Cadenas', path: '/refinanciamientos/cadenas', icon: WalletCards }, { label: 'Nuevo refinanciamiento', path: '/refinanciamientos/nuevo', icon: CreditCard }, { label: 'Reporte', path: '/refinanciamientos/reporte', icon: FileBarChart, separatorBefore: true },
  ] },
