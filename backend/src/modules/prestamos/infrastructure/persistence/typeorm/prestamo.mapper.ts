...
export class PrestamoMapper {
  static toDomain(entity: PrestamoOrmEntity): PrestamoConRelaciones {
    const domain = new Prestamo(entity.id, entity.clienteId, entity.periodicidadPagoId, entity.formaPagoId, dateFromDb(entity.fechaAlta), entity.capital, entity.interes, entity.montoTotal, entity.montoDesembolsado, entity.cantidadPagos, entity.planPersonalizado, entity.estado as EstadoPrestamo, entity.observaciones, entity.fechaCreacion, entity.fechaActualizacion);
    return Object.assign(domain, {
      cliente: relation({ id: entity.cliente.id, nombre: [entity.cliente.primerNombre, entity.cliente.segundoNombre, entity.cliente.primerApellido, entity.cliente.segundoApellido].filter((value): value is string => Boolean(value)).join(' '), identificacion: entity.cliente.identificacion }),
  ...
  static toOrm(domain: Prestamo): PrestamoOrmEntity {
    ...
    entity.clienteId = domain.clienteId; entity.periodicidadPagoId = domain.periodicidadPagoId; entity.formaPagoId = domain.formaPagoId;
