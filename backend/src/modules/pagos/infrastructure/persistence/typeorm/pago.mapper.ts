...
export class PagoMapper {
  static toDomain(entity: PagoOrmEntity): PagoConRelaciones {
    const pago = new Pago(entity.id, entity.prestamoId, entity.formaPagoId, entity.monto, entity.capitalAplicado, entity.interesAplicado, entity.cobradorId, dateFromDb(entity.fecha), entity.observaciones, entity.fechaCreacion, entity.planPagoId);
    if (!entity.formaPago || !entity.prestamo) return Object.assign(pago, { planPagoId: entity.planPagoId, numeroCuota: entity.planPago?.numeroPago ?? null }) as PagoConRelaciones;
    return Object.assign(pago, {
      ...
      cobrador: entity.cobrador ? relation({ id: entity.cobrador.id, identificacion: entity.cobrador.identificacion, nombreCompleto: entity.cobrador.nombreCompleto, telefono: entity.cobrador.telefono, correo: entity.cobrador.correo }) : relation({ id: entity.cobradorId, identificacion: '', nombreCompleto: '', telefono: null, correo: null }),
       planPagoId: entity.planPagoId,
       numeroCuota: entity.planPago?.numeroPago ?? null,
     });
  }
