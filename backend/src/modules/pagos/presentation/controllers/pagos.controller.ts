...
const response = (pago: PagoConRelaciones): PagoResponseDto => ({ id: pago.id!, prestamoId: pago.prestamoId, formaPagoId: pago.formaPagoId, monto: pago.monto, capitalAplicado: pago.capitalAplicado, interesAplicado: pago.interesAplicado, cobradorId: pago.cobradorId, fecha: pago.fecha.toISOString().slice(0, 10), fechaCreacion: pago.fechaCreacion, observaciones: pago.observaciones, planPagoId: pago.planPagoId ?? null, numeroCuota: pago.numeroCuota ?? null, estado: pago.estado, fechaAnulacion: pago.fechaAnulacion, usuarioAnulacionId: pago.usuarioAnulacionId, motivoAnulacion: pago.motivoAnulacion, observacionAnulacion: pago.observacionAnulacion, formaPago: pago.formaPago, prestamo: pago.prestamo, cliente: pago.cliente, cobrador: pago.cobrador });
